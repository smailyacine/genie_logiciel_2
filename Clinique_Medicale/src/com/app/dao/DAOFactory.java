...
Factory
	...
	DAOConfigurationException {
		...
		try {
			...
			throw new DAOConfigurationException( "Impossible decharger le fichier properties " + FICHIER_PROPERTIES, e );
...
(un seul
	...
	public DocteurDao getDocteurDao() {
		return new DocteurDaoImpl( this );
	}
